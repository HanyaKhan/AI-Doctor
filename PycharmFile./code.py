...
def get_user_input():
    ...
    if main_symptom in symptom_columns or found_in_profiles:
...
if _name_ == "_main_":
    ...
    if len(user_symptoms) > 1:  # Only predict disease if there are multiple symptoms
        ...
        print("⚠ Insufficient symptoms to predict disease. Please provide more information.")